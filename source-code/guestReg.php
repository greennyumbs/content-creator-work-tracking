<!-- Guest registration 
    Subsidiary -> Staff -> (Staff, Work, Team) -> Video => Guest_History => Guest
-->
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        // Query the database for the list of colors
            $query = "SELECT * FROM video";
            $result = mysqli_query($con, $query);

            // Generate the HTML code for the dropdown list
            $options_html = '<option disabled selected></option>'; // add a placeholder option
            while ($row = mysqli_fetch_assoc($result)) {
                $video = $row['video_name'];
                $options_html .= "<option value='$video'>$video</option>";
            }
        ?> 
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Guest registration</h1>
                    <p class="mb-4">
                        Register new guest for a subsidiary
                    </p>
                        ...
                        <div class="col-xl col-lg">
                            ...
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Guest registration form</h6>
                                </div>
                                    <div class="card-body">
                                        <form name="guestregis" method="post" action="insert.php">
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    <lable for="firstname">Guest Firstname: </lable> 
                                                    <input class="form-control" name="guest_fname" type="text" id="guest_fname" maxlength="30" placeholder="First name" required>
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <lable for="midname">Guest Middle Name: </lable>
                                                    <input class="form-control" name="guest_mname" type="text" id="guest_mname"  maxlength="30" placeholder="Middle name (Optional)">
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <lable for="lastname">Guest Last Name: </lable>
                                                    <input class="form-control" name="guest_lname" type="text" id="guest_lname" maxlength="30" placeholder="Last name" required>
                                                </div>
                                            </div>

                                            <div class="form-row">
                                                <div class="form-group col-md-2">
                                                <label for="video_name">Choose a video:</label>
                                                <select id="video_name"  class="form-control" name="video_name">
