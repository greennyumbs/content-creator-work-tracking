...
<div id="content" style=" margin-top: 25px">
    ...
    <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Average number of videos.</h1>
        <p class="mb-4">
                        Average number of videos for each team in a subsidiary.
                    </p>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Average number of videos.</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <?php
                                $query = "SELECT a.subsidiary_name, AVG(video_count) AS video_count
                                            FROM(
