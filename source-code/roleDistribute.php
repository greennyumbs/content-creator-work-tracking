        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Role Distribution in each team</h1>
                    

                    <!-- Content Row -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Role Distribution in each team</h6>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = 'SELECT role.role_name AS "Role Name", team.team_name AS "Team Name", COUNT(staff.role_id) AS "Staff Amount"
                                            FROM team LEFT JOIN (role LEFT OUTER JOIN staff ON staff.role_id = role.role_id) ON team.team_id = staff.team_id
                                            WHERE staff.role_id IS NOT NULL
                                            GROUP BY staff.team_id, staff.role_id
                                            ORDER BY role.role_name DESC';
