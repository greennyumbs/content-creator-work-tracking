                    ...
                    <div class="row">
                        ...
                        <div  style="margin-left: auto; margin-right: auto;width: 25rem;">
                            ...
                            <div class="card shadow ">
                                ...
                                <div class="card-body">
                                    <form action="sponsorForm.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group ">
                                                <label for="sponsorName">Sponsor (Company) name</label>
                                                <input type="text" class="form-control" id="sponsorName" name="sponsorName" placeholder="Name" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <label for="sponsorE">Sponsor Email</label>
                                                <input type="email" class="form-control" id="sponsorE" name="sponsorE" placeholder="Email" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group ">
                                                ...
                                                <input type="tel" class="form-control" id="sponsorPhone" name="sponsorPhone" placeholder="Phone number" required>
