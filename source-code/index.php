        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Subsidiary registration</h1>
                        ...
                        <div  style="margin-left: auto; margin-right: auto;width: 25rem;">
                            ...
                            <div class="card shadow ">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form for subsidiary</h6>
                                </div>
                                <div class="card-body">
                                    <form name="sub_regis" method="post" action="sub_insert_final.php">
                                        <div class="form-row">
                                          <label for="inputID">Subsidiary ID</label>
                                          <input type="text" pattern = "^([A-Z]{2})([0-9]){2}$" name="SubID" class="form-control" id="inputID" placeholder="Enter the subsidiary ID" required>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group">
                                              <label for="inputName">Subsidiary Name</label>
                                              <input type="text" name="SubName" class="form-control"  id="inputName" placeholder="Enter the subsidiary name" required>
                                            </div>
                                        </div>
                                
                                        <div class="form-row">
                                            <div class="form-group ">
                                            <label for="inputEmail">Subsidiary Email</label>
                                            <input type="email" name="SubMail" class="form-control"  id="inputEmail" placeholder="Enter subsidiary email">
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group ">
                                            <label for="inputFloor">Subsidiary Floor</label>
                                            <input type="text" name="SubFloor" class="form-control"  id="inputFloor" placeholder="Enter the subsidiary floor">
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group ">
                                            <label for="inputPhone">Subsidiary Phone</label>
                                            <input type="text" name="SubPhone" class="form-control"   id="inputPhone" placeholder="Enter subsidiary phone">
                                            </div>
                                        </div>
