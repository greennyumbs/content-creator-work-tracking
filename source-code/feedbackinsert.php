                                    ...
                                    <form action="feedback.php">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <?php
                                                    $sub = mysqli_real_escape_string($con,$_SESSION['sub']);
                                                    $role = mysqli_real_escape_string($con,$_SESSION['role']);
                                                    $staffid = mysqli_real_escape_string($con,$_POST['staffid']);
                                                    $workid = mysqli_real_escape_string($con,$_POST['workid']);
                                                    $feedback = mysqli_real_escape_string($con,$_POST['feedback']);               
                                                    $sql = "INSERT INTO feedback (work_id,staff_id,feedback)
                                                            VALUES ('$workid','$staffid','$feedback');";
