        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Role registration</h1>
                                ...
                                <div class="card-body">
                                    <?php
                                        if(empty($_GET['roleName'])){
                                            echo "Please enter \"Role name\"<br>";
                                        }
                                        else {
                                            $roleName = mysqli_real_escape_string($con, $_GET['roleName']);
                                            if(mysqli_fetch_array(mysqli_query($con,"SELECT role_id FROM role WHERE role_name = '$roleName'"))){
                                                echo "This role already exist in the database<br>";
                                            }
                                            else{
                                        ...
                                        mysqli_close($con);
                                    ?>
                                    <form name = "roleForm" method = "get" action = "role.php">
