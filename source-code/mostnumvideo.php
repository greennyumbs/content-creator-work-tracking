...
<div id="content" style=" margin-top: 25px">
    ...
    <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Most number of videos.</h1>
        <p class="mb-4">
                        Most number of videos in each subsidiaries by team.
                    </p>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Most number of videos.</h6>
            </div>
            <div class="card-body">
