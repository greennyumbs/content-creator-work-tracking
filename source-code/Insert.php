...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php
            ...
            $firstname = mysqli_real_escape_string($con, $_POST['guest_fname']);
            $lastname = mysqli_real_escape_string($con, $_POST['guest_lname']);
            $sql = "INSERT INTO Guest (guest_fname, guest_lname)
            ...
            if(!empty($_POST['guest_mname'])){
                $middlename = mysqli_real_escape_string($con, $_POST['guest_mname']);
                $guest = mysqli_fetch_array(mysqli_query($con,"SELECT guest_id FROM guest WHERE guest_fname = '$firstname' AND guest_lname = '$lastname'"));
                $guestID = $guest['guest_id'];
                if(!mysqli_multi_query($con, "UPDATE guest SET guest_mname = '$middlename' WHERE guest_id = '$guestID'")){
                    die('Error: ' . mysqli_error($con));
                }
                if(!empty($_POST['video_name'])){
                    $video = mysqli_real_escape_string($con, $_POST['video_name']);
                    $nsql = "INSERT INTO Guest_history (guest_history_id, video_id, guest_id)
                    SELECT '', v.video_id, g.guest_id 
                    FROM Guest g, video v
                    WHERE v.video_name = '$video' AND g.guest_fname = '$firstname' AND g.guest_mname = '$middlename' AND g.guest_lname = '$firstname'";
                    if(!mysqli_multi_query($con, $nsql)){
                        die('Error: ' . mysqli_error($con));
                    }
                }
            }
                ...
                if(!empty($_POST['video_name'])){
                    ...
                    $nsql = "INSERT INTO Guest_history (guest_history_id, video_id, guest_id)
                        SELECT '', v.video_id, g.guest_id 
                        FROM Guest g, video v
                        WHERE v.video_name = '$video' AND g.guest_fname = '$firstname' AND g.guest_lname = '$lastname'";
                    if(!mysqli_multi_query($con, $nsql)){
                        die('Error: ' . mysqli_error($con));
                    }
                }  
            }
            // SQL statement to insert data into Guest and Guest_history tables
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <div class="row">
                        ...
                        <div  style="margin-left: auto; margin-right: auto; margin-top: auto; margin-bottom: auto; width: 25rem;">
                            ...
                            <div class="card shadow ">
                                ...
                                <div class="card-body">
                                    <form name="sub_regis" method="post" action="guestReg.php">
