        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sponsor registration</h1>
                            ...
                            <div class="card shadow ">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    if (empty($_POST['sponsorName'])) {
                                        echo "Please Input Sponsor (Company) name";
                                    } elseif (empty($_POST['sponsorE'])) {
                                        echo "Please Input Sponsor Email";
                                    } elseif (empty($_POST['sponsorPhone'])) {
                                        echo "Please Input Sponsor phone number";
                                    } else {
                                        //esc//ape variables for security
                                        $name = mysqli_real_escape_string($con, $_POST['sponsorName']);

                                        $email = mysqli_real_escape_string($con, $_POST['sponsorE']);
                                        $phone = mysqli_real_escape_string($con, $_POST['sponsorPhone']);


                                        $sqlProg = "INSERT INTO  sponsor (sponsor_name, sponsor_email, sponsor_phone) VALUES ('$name', '$email', '$phone')";
