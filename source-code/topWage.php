        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Top wage</h1>
                    <p class="mb-4">
                        by content and sponsor
                    </p>    
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $sql = 'SELECT s.sponsor_name, c.content_name, COUNT(v.video_id) AS "No. of invesment", SUM(v.sponsor_wage) AS "Total wage"
                                                    FROM ((video v LEFT JOIN program p ON v.program_id = p.program_id) LEFT JOIN sponsor s ON v.sponsor_id = s.sponsor_id) LEFT JOIN content c ON c.content_id = p.content_id
                                                    WHERE v.sponsor_id IS NOT NULL
                                                    GROUP BY s.sponsor_name, c.content_name
                                                    ORDER BY SUM(v.sponsor_wage) DESC';
                                                    $result = mysqli_query($con, $sql);
                                                    $most = mysqli_fetch_array($result);
                                                    echo $most["Total wage"];
                                                    echo " Baht";
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $sql = 'SELECT AVG(temp) AS Average
                                                    FROM (SELECT s.sponsor_name, c.content_name, COUNT(v.video_id) AS "No. of invesment", SUM(v.sponsor_wage) AS temp
                                                    FROM ((video v LEFT JOIN program p ON v.program_id = p.program_id) LEFT JOIN sponsor s ON v.sponsor_id = s.sponsor_id) LEFT JOIN content c ON c.content_id = p.content_id
                                                    GROUP BY s.sponsor_name, c.content_name) AS T1;';
                                                    $result = mysqli_query($con, $sql);
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-yin-yang fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    ...
                                                    WHERE v.sponsor_id IS NOT NULL
                                                    GROUP BY s.sponsor_name, c.content_name
                                                    ORDER BY SUM(v.sponsor_wage)';
                                                    $result = mysqli_query($con, $sql);
                                                    $least = mysqli_fetch_array($result);
                                                    echo $least["Total wage"];
                                                    echo " Baht";
                                                ?>
                                            </div>
                                        </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Top wage by content & sponsor</h6>
                        </div>
                        
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0" data-order='[[ 3, "desc" ]]'>
                                    <thead>
                                        <tr>
                                            <th>Sponsor name</th>
                                            <th>Content</th>
                                            <th>No. of invesment</th>
                                            <th>Total wage</th>
                                        </tr>
                                    </thead>
                                    <tbody>
