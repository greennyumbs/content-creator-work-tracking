...
<body id="page-top">
                        ...
                        <div class="col-xl col-lg">
                            ...
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Program registration</h6>
                                </div>
                                <div class="card-body">
                                    <form action="programForm.php" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="progName">Program Name</label>
                                                <input type="text" class="form-control" id="progName" name="progName" placeholder="Name">
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-auto">
                                                <label for="cont">Content types</label>
                                                <select id="exCont" name="content" class="form-control" onchange="selectType()">
                                                    <?php
                                                ...
                                                <input type="text" class="form-control" id="newCont" name="content" placeholder="Others">
                                        ...
                                        <div class="form-row ">
                                            <div class="form-group col-md-auto">
                                                <label for="emTeam">Emcee team</label>
                                                <select id="emTeam" name="emTeam" class="form-control">
                                                    <?php
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-auto">
                                                <label for="inputState">Subsidiary</label>
                                                <select id="inputState" name="subsidiary" class="form-control">
    ...
    <script>
        function selectType(){
            ...
            const exist = document.getElementById('exCont');
            const newteam = document.getElementById('newCont');
            if (value == "Existing")
            {
